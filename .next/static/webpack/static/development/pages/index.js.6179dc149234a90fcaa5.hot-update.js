...
isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_22___default()("https://api.giphy.com/v1/gifs/search?api_key=6mGQ0OeZECHu2KHo52M4KZ5UnTRDOtaS&q=family guy&limit=12&offset=0&rating=R&lang=en").then(function (res) {
  return res.json();
}).then(function (giphy) {
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(index, [{
    ...
    value: function componentDidMount() {
      console.log(this.state.charGifs[0].images.original.url);
      console.log(this.state.charGifs[1].images.original.url);
      console.log(this.state.charGifs[2].images.original.url);
      console.log(this.state.charGifs[3].images.original.url);
      console.log(this.state.charGifs[4].images.original.url);
      console.log(this.state.charGifs[5].images.original.url);
      console.log(this.state.charGifs[6].images.original.url);
      console.log(this.state.charGifs[7].images.original.url);
      console.log(this.state.charGifs[8].images.original.url);
      console.log(this.state.charGifs[9].images.original.url);
      console.log(this.state.charGifs[10].images.original.url);
      console.log(this.state.charGifs[11].images.original.url);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.6179dc149234a90fcaa5.hot-update.js.map