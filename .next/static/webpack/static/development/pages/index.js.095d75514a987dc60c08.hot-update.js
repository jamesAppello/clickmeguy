...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(index, [{
    ...
    value: function componentDidMount() {
      console.log(this.state.charGifs[0].images.original);
      console.log(this.state.charGifs[1].images.original);
      console.log(this.state.charGifs[2].images.original);
      console.log(this.state.charGifs[3].images.original);
      console.log(this.state.charGifs[4].images.original);
      console.log(this.state.charGifs[5].images.original);
      console.log(this.state.charGifs[6].images.original);
      console.log(this.state.charGifs[7].images.original);
      console.log(this.state.charGifs[8].images.original);
      console.log(this.state.charGifs[9].images.original);
      console.log(this.state.charGifs[10].images.original);
      console.log(this.state.charGifs[11].images.original);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.095d75514a987dc60c08.hot-update.js.map