...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(index, [{
    ...
    value: function componentDidMount() {
      ...
      console.log(this.state.charGifs[1]);
      console.log(this.state.charGifs[2]);
      console.log(this.state.charGifs[3]);
      console.log(this.state.charGifs[4]);
      console.log(this.state.charGifs[5]);
      console.log(this.state.charGifs[6]);
      console.log(this.state.charGifs[7]);
      console.log(this.state.charGifs[8]);
      console.log(this.state.charGifs[9]);
      console.log(this.state.charGifs[10]);
      console.log(this.state.charGifs[11]);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.228f70df8c7dfa76901b.hot-update.js.map